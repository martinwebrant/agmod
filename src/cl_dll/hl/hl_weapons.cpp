...
void HUD_PrepEntity( CBaseEntity *pEntity, CBasePlayer *pWeaponOwner )
{
  ...
  //COM_Log(NULL,"HUD_PrepEntity precache %lx\n", pEntity);
	pEntity->Precache();

  //COM_Log(NULL,"HUD_PrepEntity spawn\n");
	pEntity->Spawn();
...
//  COM_Log(NULL,"HUD_PrepEntity( &g_Crossbow	%lx, &player - %lx ) \n", &g_Crossbow, &player);
	HUD_PrepEntity( &g_Crossbow	, &player );
//  COM_Log(NULL,"HUD_PrepEntity( &g_Shotgun	%lx, &player - %lx ) \n", &g_Shotgun, &player);
