...
//++ bullit@planethalflife.com
  ...
  AgVGuiMapBrowser *m_pMapBrowser;
	void CreateIRC( void );
	void ToggleIRC( void );
	void CreateWinamp( void );
	void ToggleWinamp( void );
  void UserCmd_Winamp( void );
	void CreatePassword( void );
  void ShowPassword( void );
  void HidePassword( void );
	void CreateMapBrowser( void );
	void ToggleMapBrowser( void );
  void SetBriefingMap(const char* pszMap)
  {
