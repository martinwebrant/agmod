...
int message_HideWeapon = 0;  // for Front Line Force (capturing)
int message_Halo = 0;        // for HolyWars (saint messages)
int message_GameMode = 0;    // for HolyWars (Beta 2 0=deathmatch, 1=halo, 2=instagib)
