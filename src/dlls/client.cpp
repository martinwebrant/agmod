...
//++ bullit@planethalflife.com
  ...
  //Extended models that came with patches.
  ...
  //Model check
	ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "models/player/gina/gina.mdl");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "models/player/hgrunt/hgrunt.mdl");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "models/player/scientist/scientist.mdl");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "models/player/gordon/gordon.mdl");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "models/player/helmet/helmet.mdl");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "models/player/robo/robo.mdl");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "models/player/barney/barney.mdl");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "models/player/recon/recon.mdl");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "models/player/zombie/zombie.mdl");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "models/player/gman/gman.mdl");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "models/player.mdl");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "models/player/blue/blue.mdl");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "models/player/red/red.mdl");

  //Texture check
  PRECACHE_GENERIC("halflife.wad");
  PRECACHE_GENERIC("liquids.wad");
  PRECACHE_GENERIC("gfx.wad");
  
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "halflife.wad");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "liquids.wad");
  ENGINE_FORCE_UNMODIFIED(force_exactfile, Vector(0, 0, 0), Vector(0, 0, 0), "gfx.wad");
	*/
#endif
#endif
//-- bullit@planethalflife.com
			...
			while ( pPlayerItem )
			{
				...
				if ( gun && gun->UseDecrement() )
				{
					...
					if ( II.iId >= 0 && II.iId < 32 )
					{
						...
						item->m_flTimeWeaponIdle		= max( gun->m_flTimeWeaponIdle, (float)-0.001 );
						item->m_flNextPrimaryAttack		= max( gun->m_flNextPrimaryAttack, (float)-0.001 );
						item->m_flNextSecondaryAttack	= max( gun->m_flNextSecondaryAttack, (float)-0.001 );
						item->m_fInReload				= gun->m_fInReload;
						item->m_fInSpecialReload		= gun->m_fInSpecialReload;
						item->fuser1					= max( gun->pev->fuser1, (float)-0.001 );
